...
public class VectorTest {
    ...
    public void retrieve_forward_vector_from_a_direction() {
        Assertions.assertThat(Vector.retrieveForwardTranslationFrom(Direction.NORTH)).isEqualTo(new Vector(0, 1));

        Assertions.assertThat(Vector.retrieveForwardTranslationFrom(Direction.SOUTH)).isEqualTo(new Vector(0, -1));

        Assertions.assertThat(Vector.retrieveForwardTranslationFrom(Direction.EAST)).isEqualTo(new Vector(1, 0));

        Assertions.assertThat(Vector.retrieveForwardTranslationFrom(Direction.WEST)).isEqualTo(new Vector(-1, 0));
    }
